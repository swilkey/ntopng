...
for _key,_value in ipairs(alerts or {}) do
   ...
   --local atype = alert_consts.getAlertType(tonumber(_value["alert_id"]), alert_entities.interface.entity_id)
   ...
   local name = alert_consts.alertTypeLabel(tonumber(_value["alert_id"]), false, alert_entities.interface.entity_id)
