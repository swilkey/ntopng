...
local other_alert_keys = {
   ...
   alert_flows_flood                    =  OTHER_BASE_KEY + 5 , -- No longer used, check alert_flows_flood_attacker and alert_flows_flood_victim
   ...
   alert_flows_flood_attacker           =  OTHER_BASE_KEY + 56,
   alert_flows_flood_victim             =  OTHER_BASE_KEY + 57,
