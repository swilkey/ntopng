...
local host_alert_flows = classes.class(alert)

-- ##############################################

host_alert_flows.meta = {
  alert_key = host_alert_keys.host_alert_flows,
...
function host_alert_flows:init(metric, value, operator, threshold)
...
function host_alert_flows.format(ifid, alert, alert_type_params)
