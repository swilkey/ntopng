...
local host_alert_traffic = classes.class(alert)

-- ##############################################

host_alert_traffic.meta = {
  alert_key = host_alert_keys.host_alert_traffic,
...
function host_alert_traffic:init(metric, value, operator, threshold)
...
function host_alert_traffic.format(ifid, alert, alert_type_params)
