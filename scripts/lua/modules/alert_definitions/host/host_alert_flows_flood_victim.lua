...
local host_alert_flows_flood_victim = classes.class(alert)

-- ##############################################

host_alert_flows_flood_victim.meta = {
  alert_key = host_alert_keys.host_alert_flow_flood_victim,
...
function host_alert_flows_flood_victim:init(metric, value, operator, threshold)
...
function host_alert_flows_flood_victim.format(ifid, alert, alert_type_params)
...
return host_alert_flows_flood_victim
