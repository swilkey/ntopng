...
local host_alert_throughput = classes.class(alert)

-- ##############################################

host_alert_throughput.meta = {
  alert_key = host_alert_keys.host_alert_throughput,
...
function host_alert_throughput:init(metric, value, operator, threshold)
...
function host_alert_throughput.format(ifid, alert, alert_type_params)
