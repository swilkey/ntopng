...
local alert_keys = {
   ntopng = {
      ...
      flow_alert_normal                          = {entities.FLOW, 0},
      flow_alert_blacklisted                     = {entities.FLOW, 1},
      flow_alert_blacklisted_country             = {entities.FLOW, 2},
      flow_alert_flow_blocked                    = {entities.FLOW, 3},
      flow_alert_data_exfiltration               = {entities.FLOW, 4},
      flow_alert_device_protocol_not_allowed     = {entities.FLOW, 5},
      flow_alert_dns_data_exfiltration           = {entities.FLOW, 6},
      flow_alert_dns_invalid_query               = {entities.FLOW, 7},
      flow_alert_elephant_flow                   = {entities.FLOW, 8},
      flow_alert_elephant_remote_to_local        = {entities.FLOW, 9},  -- No longer used, can be recycled
      flow_alert_external                        = {entities.FLOW, 10},
      flow_alert_longlived                       = {entities.FLOW, 11},
      flow_alert_low_goodput                     = {entities.FLOW, 12},
      flow_alert_malicious_signature             = {entities.FLOW, 13},
      flow_alert_internals                       = {entities.FLOW, 14},
      flow_alert_potentially_dangerous           = {entities.FLOW, 15},
      flow_alert_remote_to_remote                = {entities.FLOW, 16},
      flow_alert_suspicious_tcp_probing          = {entities.FLOW, 17},
      flow_alert_suspicious_tcp_syn_probing      = {entities.FLOW, 18},
      flow_alert_tcp_connection_issues           = {entities.FLOW, 19},
      flow_alert_tcp_connection_refused          = {entities.FLOW, 20},
      flow_alert_tcp_severe_connection_issues    = {entities.FLOW, 21},
      flow_alert_tls_certificate_expired         = {entities.FLOW, 22},
      flow_alert_tls_certificate_mismatch        = {entities.FLOW, 23},
      flow_alert_tls_old_protocol_version        = {entities.FLOW, 24},
      flow_alert_tls_unsafe_ciphers              = {entities.FLOW, 25},
      flow_alert_udp_unidirectional              = {entities.FLOW, 26},
      flow_alert_web_mining                      = {entities.FLOW, 27},
      flow_alert_tls_certificate_selfsigned      = {entities.FLOW, 28},
      flow_alert_suspicious_file_transfer        = {entities.FLOW, 29},
      flow_alert_known_proto_on_non_std_port     = {entities.FLOW, 30},
      flow_alert_flow_risk                       = {entities.FLOW, 31},
      flow_alert_unexpected_dhcp_server          = {entities.FLOW, 32},
      flow_alert_unexpected_dns_server           = {entities.FLOW, 33},
      flow_alert_unexpected_smtp_server          = {entities.FLOW, 34},
      flow_alert_unexpected_ntp_server           = {entities.FLOW, 35},
      flow_alert_zero_tcp_window                 = {entities.FLOW, 36},
      flow_alert_iec_invalid_transition          = {entities.FLOW, 37},
      flow_alert_remote_to_local_insecure_proto  = {entities.FLOW, 38},
      flow_alert_ndpi_url_possible_xss           = {entities.FLOW, 39},
      flow_alert_ndpi_url_possible_sql_injection = {entities.FLOW, 40},
      flow_alert_ndpi_url_possible_rce_injection = {entities.FLOW, 41},
      flow_alert_ndpi_http_suspicious_user_agent = {entities.FLOW, 42},
      flow_alert_ndpi_http_numeric_ip_host       = {entities.FLOW, 43},
      flow_alert_ndpi_http_suspicious_url        = {entities.FLOW, 44},
      flow_alert_ndpi_http_suspicious_header     = {entities.FLOW, 45},
      flow_alert_ndpi_tls_not_carrying_https     = {entities.FLOW, 46},
      flow_alert_ndpi_suspicious_dga_domain      = {entities.FLOW, 47},
      flow_alert_ndpi_malformed_packet           = {entities.FLOW, 48},
      flow_alert_ndpi_ssh_obsolete               = {entities.FLOW, 49},
      flow_alert_ndpi_smb_insecure_version       = {entities.FLOW, 50},
      flow_alert_ndpi_tls_suspicious_esni_usage  = {entities.FLOW, 51},
      flow_alert_ndpi_unsafe_protocol            = {entities.FLOW, 52},
      flow_alert_ndpi_dns_suspicious_traffic     = {entities.FLOW, 53},
      flow_alert_ndpi_tls_missing_sni            = {entities.FLOW, 54},
      flow_alert_iec_unexpected_type_id          = {entities.FLOW, 55},
