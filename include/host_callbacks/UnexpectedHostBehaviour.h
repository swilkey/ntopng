...
#ifndef _UNEXPECTED_HOST_BEHAVIOUR_H_
#define _UNEXPECTED_HOST_BEHAVIOUR_H_

#include "ntop_includes.h"

class UnexpectedHostBehaviour : public HostCallback {
private:
...
public:
  ...
  HostCallbackType getType() const { return host_callback_unexpected_host_behaviour; }
