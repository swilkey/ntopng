...
void IdleTime::periodicUpdate(Host *h) {
}

/* ***************************************************** */

HostAlert *IdleTime::buildAlert(Host *h) {
  return new IdleTimeAlert(this, h);
}

/* ***************************************************** */

bool IdleTime::loadConfiguration(json_object *config) {
