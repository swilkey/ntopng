...
void ActivityTime::periodicUpdate(Host *h) {
}

/* ***************************************************** */

HostAlert *ActivityTime::buildAlert(Host *h) {
  return new ActivityTimeAlert(this, h);
}

/* ***************************************************** */

bool ActivityTime::loadConfiguration(json_object *config) {
